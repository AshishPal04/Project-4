...
{
    cout<<getName()<<" is a Level "<<getLevel()<<" "<<getRace()<<" SCOUNDREL."<<endl;
    cout<<"Vitality: "<<getVitality()<<endl;
    cout<<"Armor: "<<getArmor()<<endl;
    cout<<"They are "<<(isEnemy() ? "an enemy." : "not an enemy.")<<endl;
    cout<<"Dagger: "<<getDagger()<<endl;
    cout<<"Faction: "<<getFaction()<<endl;
    cout<<"Disguise: "<<(hasDisguise() ? "TRUE" : "FALSE")<<"\n"<<endl;
}
