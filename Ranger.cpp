...
{
    cout<<getName()<<" is a Level "<<getLevel()<<" "<<getRace()<<" RANGER."<<endl;
    cout<<"Vitality: "<<getVitality()<<endl;
    cout<<"Armor: "<<getArmor()<<endl;
    cout<<"They are "<<(isEnemy() ? "an enemy." : " not an enemy.")<<endl;
    cout << "Animal Companion: " << (getCompanion() ? "TRUE" : "FALSE") << endl;
    cout<<"Arrows: "<<endl;
    const vector<Arrows> arrows = getArrows();
    ...
    cout<<endl;
    cout<<"Affinities: ";
    const vector<string> affinities = getAffinities();
